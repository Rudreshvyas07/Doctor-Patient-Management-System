...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-100 via-white to-blue-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="bg-white dark:bg-gray-900 shadow-2xl rounded-2xl p-12 max-w-2xl w-full min-h-[650px] flex flex-col justify-center border border-blue-100 dark:border-gray-800">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-3xl font-extrabold text-gray-800 dark:text-white">Sign up</h2>
          <p className="text-gray-500 dark:text-gray-300 mt-1">Create your account to get started!</p>
        </div>
